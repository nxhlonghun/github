...
插件使用方法:1.首先为所有需要运动的部分建立原点和坐标系，x轴方向为设备的正方向，z轴向上
...
2.新建webots工程文件:1.打开webots新建工程文件，在下图这一步只勾选第一个
                        ![alt text](image-13.png)
3.文件转换:1.得到sw插件导出的文件之后，将其拷贝到webots工程文件的protos目录下
...
4.导入webots:  1.打开刚才新建的webots工程，点击上方的暂停键，删除世界中的背景，之后再3D框中右键点击新增
